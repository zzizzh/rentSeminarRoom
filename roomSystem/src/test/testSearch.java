...
public class testSearch {
	public static void main(String[] args)
	{
		...
		list.addRoom(new conferenceRoom("회의실01", "서울특별시강남구", "20", "10", "지재민","company1@knu.ac.kr",0, new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room1.png")));
		list.addRoom(new conferenceRoom("회의실02", "서울특별시강남구", "25", "10", "지재민","company2@knu.ac.kr",1,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room2.png")));
		list.addRoom(new conferenceRoom("회의실03", "서울특별시강남구", "25", "15", "지재민","company1@knu.ac.kr",2,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room1.png")));
		list.addRoom(new conferenceRoom("회의실04", "서울특별시강남구", "30", "10", "지재민","company2@knu.ac.kr",3,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room2.png")));
		list.addRoom(new conferenceRoom("회의실05", "서울특별시강동구", "20", "10", "지재민","company1@knu.ac.kr",4,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room1.png")));
		list.addRoom(new conferenceRoom("회의실06", "서울특별시강동구", "25", "10", "지재민","company2@knu.ac.kr",5,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room2.png")));
		list.addRoom(new conferenceRoom("회의실07", "서울특별시강동구", "25", "15", "지재민","company1@knu.ac.kr",6,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room1.png")));
		list.addRoom(new conferenceRoom("회의실08", "서울특별시강서구", "20", "10", "지재민","company2@knu.ac.kr",7,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room2.png")));
		list.addRoom(new conferenceRoom("회의실09", "서울특별시강북구", "20", "10", "지재민","company1@knu.ac.kr",8,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room1.png")));
		list.addRoom(new conferenceRoom("회의실10", "서울특별시강북구", "25", "10", "지재민","company2@knu.ac.kr",9,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room2.png")));
		list.addRoom(new conferenceRoom("회의실11", "서울특별시강북구", "30", "10", "지재민","company1@knu.ac.kr",10,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room1.png")));
		list.addRoom(new conferenceRoom("회의실12", "서울특별시강북구", "20", "20", "지재민","company2@knu.ac.kr",11,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room2.png")));
		list.addRoom(new conferenceRoom("회의실13", "서울특별시강북구", "25", "20", "지재민","company1@knu.ac.kr",12,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room1.png")));
		list.addRoom(new conferenceRoom("회의실14", "서울특별시강북구", "25", "25", "지재민","company2@knu.ac.kr",13,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room2.png")));
		list.addRoom(new conferenceRoom("회의실15", "서울특별시강남구", "20", "10", "지재민","company1@knu.ac.kr",14,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room1.png")));
		list.addRoom(new conferenceRoom("회의실16", "서울특별시강남구", "25", "10", "지재민","company2@knu.ac.kr",15,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room2.png")));
		list.addRoom(new conferenceRoom("회의실17", "서울특별시강남구", "30", "15", "지재민","company1@knu.ac.kr",16,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room1.png")));
		list.addRoom(new conferenceRoom("회의실18", "서울특별시강남구", "35", "20", "지재민","company2@knu.ac.kr",17,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room2.png")));
		list.addRoom(new conferenceRoom("회의실19", "서울특별시강남구", "20", "10", "지재민","company1@knu.ac.kr",18,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room1.png")));
		list.addRoom(new conferenceRoom("회의실20", "서울특별시강남구", "25", "20", "지재민","company2@knu.ac.kr",19,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room2.png")));
		list.addRoom(new conferenceRoom("회의실21", "서울특별시강남구", "30", "25", "지재민","company1@knu.ac.kr",20,new ImageIcon("C:\\Users\\hyesung_2\\Desktop\\room1.png")));
